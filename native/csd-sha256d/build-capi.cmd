@echo off
REM Build csd_capi.dll (SYCL JIT). %1 = output name (default csd_capi.dll).
setlocal
set "OUT=%~1"
if "%OUT%"=="" set "OUT=csd_capi.dll"
...
cd /d "%~dp0"
icpx -fsycl -fsycl-device-code-split=per_kernel -O3 -shared csd_capi.cpp -o "%OUT%"
exit /b %ERRORLEVEL%
